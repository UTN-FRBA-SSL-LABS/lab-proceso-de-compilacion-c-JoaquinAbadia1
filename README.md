...
> **R:** porque cuando compilamos el archivo, copia el contenido de los include.
...
> **R:** ocurre por que no hubo ninguna coincidencia con "Archivo fuente principal"
...
> **R:** no aparece nada y en el segundo printf("[DEBUG] %s\n", ("Iniciando main"));
> 
...
> **R:** Las líneas # N "archivo" indican el archivo y el número de línea de donde proviene el código que sigue en la salida del preprocesador. El bloque que contiene la declaración de printf proviene del archivo c:\mingw\include\stdio.h.
...
> **R:**Porque en programa.o la función solo está declarada pero no implementada, por lo que el archivo objeto marca el símbolo como U (Undefined) indicando que necesita buscarlo en otro lugar. En cambio, en matematica.o, la función está escrita y definida, por lo que aparece como T (Text/Código), indicando que el código ejecutable de esa función reside en ese archivo.
...
> **R:**Quedan símbolos tipo U porque corresponden a funciones de la biblioteca dinámica del sistema.Los resuelve el cargador dinámico.En el tiempo de ejecución se resuelven, justo en el momento en que lanzas el programa para que se abra.
...
> **R:**Macro: Es un simple "buscar y reemplazar" de texto. Desaparece en el PREPROCESAMIENTO y no verifica tipos de datos.

Función real: Es un bloque de código con dirección de memoria. Desaparece (se resuelve) en el ENLAZADO y sí tiene verificación de tipos.
...
> **R:**Tipo T (Text): Es el código de las funciones (las instrucciones). Vive en la sección .text.

Tipo D (Data): Son las variables globales inicializadas. Vive en la sección .data.
...
> **R:**ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7ffc856e0000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x77c50000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7ffc85180000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7ffc83f10000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7ffc85590000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7ffc84ce0000)
